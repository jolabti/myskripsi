...
<body>
  <nav class="navbar navbar-default no-margin">
    ...
    <div class="navbar-header fixed-brand">
      ...
      <a class="navbar-brand" href="#"><i class="fa fa-rocket fa-4"></i> SPK-TI HIMPUNAN</a>
    </div>
    <!-- navbar-header-->
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav  nav-stacked" id="menu">
        ...
        <li class="fa-stack fa-lg pull-left">
          ...
          <!-- <form method="post" action="<?php   base_url();?>index.php/nilaicalonasistencontroller/import_csv_calas" enctype="multipart/form-data">
