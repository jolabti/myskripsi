  ...
  <div id="wrapper">
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav  nav-stacked" id="menu">
        ...
        <li>
        <a href="<?php echo base_url();?>index.php/Calonsiswacontroller/"><span class="fa-stack fa-lg pull-left"><i class="fa fa-cloud-download fa-stack-1x "></i></span>DATA CALAS</a>        </li>
        <li>
